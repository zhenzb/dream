    ...
    <div class="main-content clear-fix" style="margin-bottom: 20px;">
        <div class="left-nav" style="height: 968px;">
            <ul class="ul-nav Games">
                ...
                <li id="Captcha">
                    <a href="/silverPersonalCenter" style="color: #31c37c;">银豆明细</a>
                </li>
                <li id="Order" >
        ...
        <div class="right-content">
            ...
            <div class="personal-each-box">
                <div class="title">
                    <span class="box-name">提现明细</span>
                </div>
                <div class="personal-tbl ubi-tbl">
                    <div class="tr thead">
                        <p class="th td1">订单号</p>
                        <p class="th td2">时间</p>
                       <%-- <p class="th td3">&nbsp;</p>--%>
                        <p class="th td4">提现账户</p>
                        <p class="th td4">事件</p>
                        <p class="th td4">提现金额</p>
                        <p class="th td4">扣除金币</p>
                        <p class="th td4">账户余额</p>
                    </div>
                    <div class="tbody J_myAccountTbody">
                        ...
                        <c:forEach items="${userFlowMeterList}" var="list">
                            <div class="tr">
                                ...
                                <%--<p class="td3">&nbsp;</p>--%>
                                <p class="td4" title="聚财宝第143970期2018-01-20 收益4U币">${list.alipayAccount}</p>
                                <p class="td4" title="聚财宝第143970期2018-01-20 收益4U币">${list.reason}</p>
                                <p class="td4 ">
                                        ${list.changeSilverBean/10000}元
                                    <i class="ubi"></i>
                                </p>
                                <p class="td4 ">
                                        ${list.changeSilverBean}银豆
                                    <i class="ubi"></i>
                                </p>
                                <p class="td4">${list.currentSilverBean}&nbsp;&nbsp;<i class="ubi"></i></p>
                            </div>
