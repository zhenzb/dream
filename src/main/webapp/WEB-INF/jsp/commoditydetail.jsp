        ...
        <div class="block-top">
            <div id="goodsinfo">
                ...
                <div class="bl goods-pic">
                    <img src="${seckill.imgUrl}" style="width: 100%;height: 100%">
                </div>
            <c:if test="${empty sessionScope.user}">
                <div class="br goods-info">
                    <h3>${seckill.name}</h3>
                    <p class="goods-title color-999">${seckill.name}</p>
                    <div class="goods-price-wrapper">
                        <p>商品价格：<em class="color-udou">登录后查看<s class="udou"></s></em></p>
                        <p>商品数量：<em class="color-udou">登录后查看</em></p>
                        <p>所在地址：<em class="color-udou">${seckill.address}<s class="udou"></s></em></p>
                        <p>购买热线：<em class="color-udou">登录后查看<s class="udou"></s></em></p>
                        <p>商品概述：<em class="color-udou">${seckill.merchantDescribe}</em></p>
            ...
            <c:if test="${not empty sessionScope.user}">
                <div class="br goods-info">
                    ...
                    <p class="goods-title color-999">${seckill.name}</p>
                    <div class="goods-price-wrapper">
                        <p>商品价格：<em class="color-udou">${seckill.price}元<s class="udou"></s></em></p>
                        <p>商品数量：<em class="color-udou">${seckill.number}</em></p>
                        <p>所在地址：<em class="color-udou">${seckill.address}<s class="udou"></s></em></p>
                        <p>购买热线：<em class="color-udou">${seckill.originalPrice}<s class="udou"></s></em></p>
                        <p>商品概述：<em class="color-udou">${seckill.merchantDescribe}</em></p>
                       <%-- <p>您的账户中有：0<s class="udou"></s></p>--%>
                    </div>
                    <%--<a href="javascript:;" id="seckill-box" class="exchange-btn J_exchangeBtn" data-exchangeType="1" data-address="0" data-pwd="true">立即抢购</a>--%>
        ...
        <div class="block-main">
            <div id="goodsintro" class="mr20">
                ...
                <div class="tab-index tab-index-1">
                    <img alt="" src="${seckill.bigOneImgUrl}"  title="" align="" /><br />
                    <img alt="" src="${seckill.bigTwoImgUrl}"  title="" align="" /><br />
                    <img alt="" src="${seckill.bigThreeImgUrl}"<%--width="750" height="1173"--%> title="" align="" />
                </div>
