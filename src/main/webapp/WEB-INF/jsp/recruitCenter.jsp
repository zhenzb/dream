...
<div id="left-right-layout">
    <div class="main-content clear-fix" style="margin-bottom: 20px;">
        ...
        <ul class="ul-nav Games">
            ...
            <li id="recruits">
                <a href="/recruitCenter" style="color: #31c37c;">招聘记录</a>
            </li>
            <li id="Order" >
                <a href="/pg" >发布商品</a>
            </li>
        ...
        <div class="right-content">
            ...
            <div class="personal-each-box">
                <div class="title">
                    <span class="box-name">招聘记录</span>
                </div>
                <div class="personal-tbl ubi-tbl">
                    <div class="tr thead">
                        <p class="th td1">公司名称</p>
                        <p class="th td1">招聘职位</p>
                       <%-- <p class="th td3">&nbsp;</p>--%>
                        <p class="th td1">招聘人数</p>
                        <p class="th td1">薪资待遇</p>
                        <p class="th td1">招聘时间</p>
                        <p class="th td1">联系人</p>
                        <p class="th td1">联系电话</p>
                        <p class="th td1">招聘状态</p>
                    </div>
                    <div class="tbody J_myAccountTbody">

                        <c:forEach items="${recruitlist}" var="list">
                        <div class="tr">
                            <p class="td1"> ${list.companyName}</p>
                            <p class="td1"> ${list.positionType}</p>
                            <p class="td1"> ${list.recruitNumber}</p>
                            <p class="td1"> ${list.welfare}</p>
                            <p class="td1"> <fmt:formatDate value="${list.lastModified}" pattern="yyyy-MM-dd HH:mm:ss" /></p>
                            <p class="td1"> ${list.contactsName}</p>
                            <p class="td1"> ${list.contactsPhone}</p>
                            <%--<p class="td1"> ${list.recordStatus}</p>--%>
                            <%--<p class="td3">&nbsp;</p>--%>
