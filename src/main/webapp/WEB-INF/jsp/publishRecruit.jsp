    ...
    <div class="main-content clear-fix" style="margin-bottom: 20px;">
        <div class="left-nav" style="height: 968px;">
            <ul class="ul-nav Games">
                ...
                <li id="recruit" >
                    <a href="/publishRecruit" style="color: #31c37c;">发布招聘</a>
                </li>
                <li id="P2P">
                        ...
                        <div action="" class="form-group" id="form">
                            <div class="form-group-select">
                                ...
                                <form method="post" class="form-group" id="formUpdate"
                                    ...
                                    <div class="activeForm" id="activeForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="activeTitle">
                                                <input type="text" name="companyName" id="title" style="width: 100%;"
                                                       placeholder="请在此填写单位名称..." maxlength="10"/>
                                            </div>
                                            <div class="tips">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="activeTitle">
                                                <input type="text" name="positionType" id="positionTypeId" style="width: 100%;"
                                                       placeholder="请在此填写招聘职位..." maxlength="10"/>
                                            </div>
                                            <div class="tips">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="activeTitle">
                                                <input type="text" name="recruitNumber" id="recruitNumberId" style="width: 100%;"
                                                       placeholder="请在此填写招聘人数..." maxlength="10"/>
                                            </div>
                                            <div class="tips">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="activeTitle">
                                                <input type="text" name="contactsName" id="ContactsNameId" style="width: 100%;"
                                                       placeholder="请在此填写福利待遇..." maxlength="10"/>
                                            </div>
                                            <div class="tips">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="activeNum">
                                                <input type="tel" id="ContactsPhoneId" name="contactsPhone"
                                                       style="width: 100%;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="activeTitle">
                                                <input type="text" name="jobAddress" id="jobAddressId" style="width: 100%;"
                                                       placeholder="请在此填工作地址..." maxlength="50"/>
                                            </div>
                                            <div class="tips">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="activeTime">
                                                招聘时间:<input type="text" class="demo-input" placeholder="请选择日期" id="startDate"
                                    ...
                                    <textarea placeholder="请在此填写其他说明50字内..." id="RemarksId" name="remarks"
