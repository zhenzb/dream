    ...
    <div id="left-right-layout">
        ...
        <div class="block-top">
            <div id="goodsinfo">
                ...
                <div class="bl goods-pic">
                    <img src="${recruit.logoUrl}" style="width: 100%;height: 100%">
                </div>
            <c:if test="${empty sessionScope.user}">
                <div class="br goods-info">
                    <h3>${recruit.companyName}</h3>
                    <p class="goods-title color-999">${recruit.companyName}</p>
                    <div class="goods-price-wrapper" style="display: inline">
                        <p style="float: left;width: 44%;">公司名称：<em class="color-udou">${recruit.companyName}<s class="udou"></s></em></p>
                        <p >招聘职位：<em class="color-udou">${recruit.positionType}</em></p>
                        <p style="float: left;width: 44%;">招聘人数：<em class="color-udou">${recruit.recruitNumber}<s class="udou"></s></em></p>
                        <p>学历要求：<em class="color-udou">${recruit.education}<s class="udou"></s></em></p>
                        <p style="float: left;width: 44%;">工作年限：<em class="color-udou">${recruit.duration}<s class="udou"></s></em></p>
                        <p>薪资待遇：<em class="color-udou">${recruit.welfare}</em></p>
                        <p style="float: left;width: 44%;">工作地点：<em class="color-udou">${recruit.jobAddress}<s class="udou"></s></em></p>
                        <p >联系人：<em class="color-udou">${recruit.contactsName}<s class="udou"></s></em></p>
                        <p style="float: left;width: 44%;">联系电话：<em class="color-udou">登录查看<s class="udou"></s></em></p>
            ...
            <c:if test="${not empty sessionScope.user}">
                <div class="br goods-info">
                    ...
                    <div class="goods-price-wrapper">
                        <p>公司名称：<em class="color-udou">${recruit.companyName}<s class="udou"></s></em></p>
                        <p>招聘职位：<em class="color-udou">${recruit.positionType}</em></p>
                        <p>招聘人数：<em class="color-udou">${recruit.recruitNumber}<s class="udou"></s></em></p>
                        <p>学历要求：<em class="color-udou">${recruit.education}<s class="udou"></s></em></p>
                        <p>工作年限：<em class="color-udou">${recruit.duration}</em></p>
                        <p>薪资待遇：<em class="color-udou">${recruit.welfare}</em></p>
                        <p>工作地点：<em class="color-udou">${recruit.jobAddress}</em></p>
                        <p>联系人：<em class="color-udou">${recruit.contactsName}</em></p>
                        <p>联系电话：<em class="color-udou">${recruit.contactsPhone}</em></p>
                       <%-- <p>您的账户中有：0<s class="udou"></s></p>--%>
                    </div>
                    <%--<a href="javascript:;" id="seckill-box" class="exchange-btn J_exchangeBtn" data-exchangeType="1" data-address="0" data-pwd="true">立即抢购</a>--%>
                   <%-- <p class="color-999">仅限大陆地区配送，秒购确认后3-5天内发货 免运费</p>--%>
        ...
        <div class="block-main">
            <div id="goodsintro" class="mr20">
                <div class="tab">
                    <a href="javascript:;" class="tab-item J_tabItem tab-item1 active" data-index="1"><span>其他说明</span></a>
                ...
                <div class="p2p-gain-list mr20">
                    <div class="listbar-box">
                        <h3 class="listbar-text">
                            <i class="listbar-icon icon-try"></i>广告位招商
                        </h3>
                    </div>
