...
import com.force4us.comm.SessionUtil;
...
public class RandCodeImageServlet {
	...
	private static final String SESSION_RAND_CODE_TIME = "randCodeTime";
    /**
	 * 
	 */
...
//			graphics.setFont(new Font("Arial Black", Font.ITALIC, 18));
		...
		request.getSession().setAttribute(SESSION_RAND_CODE_TIME,System.currentTimeMillis());
		// 图象生效
		graphics.dispose();
