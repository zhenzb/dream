...
public interface SeckillService {
    ...
    List<SeckillEntity> findSeckillEntityByState();

    List<SeckillEntity> findSeckillEntity();

    List<SeckillEntity> findSeckillEntityByStateAndName(String name);
    /**
     * 查询单个秒杀记录
     * @param seckillId
     * @return
    ...
    SeckillExecution executeSeckillProcedure(long seckillId,long userPhone,String md5, HttpSession session)
            throws SeckillException,RepeatKillException,SeckillCloseException;
